...
const TestPage = () => {
  ...
  // ✅ Safe: fetchLanguages is memoized
  useEffect(() => {
    fetchLanguages();
  }, [fetchLanguages]);
  ...
  }, [lang_id, category, getQuestions, initialRenderQuestions]);
  ...
  }, [questions, initialRenderAnswers]);
    ...
    <>
      ...
      <Container maxW="xl" py={8} px={4} mt={12}>
        ...
        {shouldShow ? (
          ...
          <Text mt={5} fontSize="xl" color="black" textAlign="center">
            Select a Course and the difficulty level for the quiz
          </Text>
        )}
      </Container>
    </>
